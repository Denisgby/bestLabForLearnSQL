...
---------------------------------------------------------------------
select em.empid, em.lastname, em.firstname, em.title,  em.mgrid
...
select em.empid, em.lastname, em.firstname, em.title,  em.mgrid, mg.lastname, mg.firstname
from hr.employees em join hr.Employees mg ON em.mgrid=mg.empid